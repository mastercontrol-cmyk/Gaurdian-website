...
export function PrivacyVault() {
  ...
  useEffect(() => {
    ...
    function draw() {
        ...
        ctx.fillStyle = "rgba(220, 38, 38, 0.5)"; // Red matrix rain
  ...
  return (
    <section className="py-32 w-full px-6 md:px-12 bg-[#0B0F1A]">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16">
        ...
        <div className="w-full md:w-1/2 flex justify-center perspective-[1200px]">
          ...
          >
             ...
             <motion.div 
                ...
                className="absolute top-10 left-[-40px] text-[8px] font-mono text-white/30 uppercase tracking-[0.3em] bg-black/40 backdrop-blur px-2 py-1 border border-white/5"
             >
                Encryption: GCM-AES
             </motion.div>
             ...
             <motion.div 
                initial={{ opacity: 0, x: 20 }}
                whileInView={{ opacity: 1, x: 0 }}
                className="absolute bottom-20 right-[-40px] text-[8px] font-mono text-red-500/50 uppercase tracking-[0.3em] bg-black/40 backdrop-blur px-2 py-1 border border-red-500/20"
             >
        ...
        <div className="w-full md:w-1/2 space-y-12">
            <div>
                ...
                <h3 className="text-4xl md:text-7xl font-bold text-white leading-none uppercase tracking-tighter">
