...
export function Footer() {
  return (
    <footer className="w-full py-16 px-6 md:px-12 bg-[#050608] border-t border-white/5 relative overflow-hidden">
      {/* Background Graphic */}
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-12 relative z-10">
        ...
        <div className="flex flex-col gap-6 max-w-sm">
          <div className="flex items-center gap-3">
            <img src={logoSymbol} alt="Guardian Logo" className="w-8 h-8 object-contain" />
            <span className="text-2xl font-bold tracking-tight text-white">Guardian</span>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-12 md:gap-24">
            <div className="flex flex-col gap-4">
                ...
                <Link to="#" className="text-sm text-white/50 hover:text-white transition-colors">Features</Link>
                <Link to="#" className="text-sm text-white/50 hover:text-white transition-colors">Hardware</Link>
                <Link to="#" className="text-sm text-white/50 hover:text-white transition-colors">App</Link>
                <Link to="#" className="text-sm text-white/50 hover:text-white transition-colors">Pricing</Link>
            </div>
            <div className="flex flex-col gap-4">
                <h4 className="text-white font-bold uppercase tracking-wider text-xs">Company</h4>
                <Link to="#" className="text-sm text-white/50 hover:text-white transition-colors">About</Link>
                <Link to="#" className="text-sm text-white/50 hover:text-white transition-colors">Careers</Link>
                <Link to="#" className="text-sm text-white/50 hover:text-white transition-colors">Blog</Link>
                <Link to="#" className="text-sm text-white/50 hover:text-white transition-colors">Contact</Link>
            </div>
            <div className="flex flex-col gap-4">
                ...
                <Link to="#" className="text-sm text-white/50 hover:text-white transition-colors">Cookie Policy</Link>
            </div>
        </div>
      </div>
